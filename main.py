...
# --- THEME DESIGN SYSTEM (Rose Gold Velvet) ---
BG = '#161214'
SURFACE = '#261E22'
TEXT = '#FFF0F5'
MUTED = '#B8A4AD'
...
def main(page: ft.Page):
            ...
            ft.Container(
                ...
                content=ft.Column([
                    ...
                    ft.Row([
                        ...
                        ft.Text("Karlhamberera24@gmail.com", color=MUTED, size=14, selectable=True),
                    ], wrap=True),
                    ft.Row([
                        ft.Icon(ft.Icons.LINK, size=15, color=ACCENT),
                        ft.Text("GitHub Profile: github.com/karlhamberera", color=ACCENT, size=14, selectable=True)
                    ], wrap=True),
                ], spacing=12)
            ),
    ...
    # Files list
    files_list = []
    for f in ['docs/Firebase_Setup_Guide.md', 'firestore.indexes.json', 'shared/data-model.md']:
        files_list.append(
            ft.Container(
                padding=10,
                border_radius=6,
        ...
        content=ft.ResponsiveRow([
            ...
            ft.Container(
                ...
                content=tile_card("My Project Focus", [
                    ft.Text("Firestore data model documentation and indexes.", size=14, color=TEXT),
            ...
            ft.Container(
                ...
                content=tile_card("Submission Information", [
                    ...
                    ft.Text('git config user.name "Hamberera Karl PM"\ngit config user.email "Karlhamberera24@gmail.com"', size=11, font_family="Consolas", color=TEXT, selectable=True),
                    ft.Divider(color=BORDER),
    ...
    footer = ft.Container(
        ...
        content=ft.Column([
            ft.Text("Hamberera Karl PM | SiteSpy Portfolio Showcase", color=TEXT, size=14, weight=ft.FontWeight.BOLD),
